...
export {NorthwindModel as NorthwindModel}

declare module Nortwind {
...
export {Nortwind as Nortwind}

export var type: typeof Nortwind.NorthwindEntities;
export var factory: (config:any) => Nortwind.NorthwindEntities;