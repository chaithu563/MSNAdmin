System.register(["@angular/core", "../../../services/msn.service", "@angular/router"], function (exports_1, context_1) {
    ...
    var core_1, msn_service_1, router_1, SubCategoriesComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            SubCategoriesComponent = (function () {
                function SubCategoriesComponent(mSNService, router) {
                ...
                SubCategoriesComponent.prototype.onCategoryChange = function (id) {
                    var _this = this;
                    this.mSNService.getContext(function (context) { return _this.OnContextLoaded(context, id); });
                };
                SubCategoriesComponent.prototype.OnContextLoaded = function (context, id) {
                    var _this = this;
                ...
                SubCategoriesComponent.prototype.createRowData = function () {
                    var rowData = [];
                ...
                SubCategoriesComponent.prototype.createColumnDefs = function () {
                    this.columnDefs = [
                        {
                ...
                SubCategoriesComponent.prototype.calculateRowCount = function () {
                ...
                SubCategoriesComponent.prototype.editCellRenderer = function (params) {
                ...
                SubCategoriesComponent.prototype.onRowClicked = function (e) {
                ...
                SubCategoriesComponent.prototype.onActionViewClick = function (data) {
                    this.router.navigate(['subcategories', data.id]);
                };
                SubCategoriesComponent.prototype.onActionRemoveClick = function (data) {
                    var _this = this;
                ...
                SubCategoriesComponent.prototype.OnCategoriesContextLoaded = function (context) {
                    var _this = this;
                    _this.context = context;
                ...
                SubCategoriesComponent.prototype.loadCategoriesContext = function () {
                    var _this = this;
                    this.mSNService.getContext(function (context) { return _this.OnCategoriesContextLoaded(context); });
                };
                SubCategoriesComponent.prototype.getCategoriesOnOpen = function () {
                    this.loadCategoriesContext();
                };
                SubCategoriesComponent.prototype.doSomeActionOnClose = function () {
                };
            ...
            exports_1("SubCategoriesComponent", SubCategoriesComponent);
        }
    };
});
