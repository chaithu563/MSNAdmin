(function(mod) {
    ...
    exports.type = types["Nortwind.NorthwindEntities"] = $data("$data.EntityContext").extend("Nortwind.NorthwindEntities", {
        Categories: {
            "type": "$data.EntitySet",
    ...
    exports.Nortwind = {
        "NorthwindEntities": types["Nortwind.NorthwindEntities"]
    };
